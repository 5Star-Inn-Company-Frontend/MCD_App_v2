            ...
            children: [
              Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      '$providerName $typeName $planName',
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Obx(
                      () => Text(
                        controller.mcdDataBaseCost.value,
                        style: const TextStyle(
                          color: AppColors.textPrimaryColor,
                          fontSize: 14,
                          fontWeight: FontWeight.bold,
              ...
              TextField(
                controller: TextEditingController(text: controller.dataSellPrice.value),
              ...
              const SizedBox(height: 8),
              const Text(
                'Commission per sale: N50', // Fixed value for UI prototype
                style: TextStyle(
